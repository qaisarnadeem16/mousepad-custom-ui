...
export const FooterMobileContainer = styled.div<FooterMobileContainerProps>`
	height: 70px;
	display: grid;
	grid-template-columns: repeat(
		${(props: FooterMobileContainerProps) => (props.$visibleAreas ? props.$visibleAreas.length : 5)},
		1fr
	);
